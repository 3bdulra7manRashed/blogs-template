...
@section('title', 'إنشاء وسم جديد')

@section('content')
<div class="mb-6 flex items-center justify-between">
    <h1 class="text-3xl font-serif font-bold text-brand-primary">إنشاء وسم جديد</h1>
            ...
            <div class="bg-white p-6 rounded shadow">
                ...
                <div class="flex items-center">
                    <span id="tag-preview" class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-brand-accent text-white">
                        ...
                        <span id="preview-text">اسم الوسم</span>
                    </span>
                </div>
...
<script>
    ...
    nameInput.addEventListener('input', function() {
        const name = this.value || 'اسم الوسم';
